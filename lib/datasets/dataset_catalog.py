...
DATASETS = {
    ...
    'coco_2017_train_extract': {
        IM_DIR:
            _DATA_DIR + '/coco/images/train2017',
        ANN_FN:
            _DATA_DIR + '/coco/annotations/instances_train2017_extract.json',
    },
    'coco_val_debug': {
        IM_DIR:
            _DATA_DIR + '/coco/images/val2017',
        ANN_FN:
            _DATA_DIR + '/coco/annotations/test.json',
    },
    'coco_val_1000': {
        IM_DIR:
            _DATA_DIR + '/coco/images/val2017',
        ANN_FN:
            _DATA_DIR + '/coco/annotations/test1000.json',
    },
    'tt100k_train': {
        IM_DIR:
            _DATA_DIR + '/tt100k/images/train',
        ANN_FN:
            _DATA_DIR + '/tt100k/annotations/TT100K_train_coco_format.json',
    },
    'tt100k_test': {
        IM_DIR:
            _DATA_DIR + '/tt100k/images/test',
        ANN_FN:
            _DATA_DIR + '/tt100k/annotations/TT100K_test_coco_format.json',
    },
    'tt100k_test-test': {
        IM_DIR:
            _DATA_DIR + '/tt100k/images/test',
        ANN_FN:
            _DATA_DIR + '/tt100k/annotations/TT100K_test_coco_format-test.json',
    }
}
