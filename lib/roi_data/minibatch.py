...
seq = iaa.SomeOf((0, 3), [
                ...
                iaa.Multiply((0.5, 1.3), per_channel=0.5),
...
def get_minibatch(roidb):
    ...
    if cfg.RPN.RPN_ON:
        ...
        valid = roi_data.rpn.add_rpn_blobs(blobs, im_scales, roidb) #add im_info, roidb dont resize
...
def _get_image_blob(roidb):
    ...
    for i in range(num_images):
        ...
        if cfg.TRAIN.COLOR_JITTER:
            ...
            im = seq_det.augment_images([im])[0]
        ...
        im, im_scale = blob_utils.prep_im_for_blob(
            im, cfg.PIXEL_MEANS, [target_size], cfg.TRAIN.MAX_SIZE) # return original_img * img_scale, img_scale
